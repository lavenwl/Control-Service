...
<body>	
	...
	<div id=fields>
		...
		<tr>
			<td width="220px">
				<h3>本次搜索结果数据量：${num}条</h3>
			</td>
			<td>
				<a href="/control/marketing_files/confirm.action?actionName=5"><input type="button" class="button" value="返回上一层 " /></a>
				...
				<input type="button" class="button" value="下载数据 " onclick="download()"/>
				<div id=filter style="display: none; float: right;">
					<form method="get" action="/control/marketing_files/d${actionName}.action" style="display: inline-block; font-size: 13px; color: grey;" >
						<input name="isNull" value="filter" type="checkbox">过滤电话为空的用户&nbsp;&nbsp;
