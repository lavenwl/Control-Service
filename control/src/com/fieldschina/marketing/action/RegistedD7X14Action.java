 ...
 * @version 创建时间：2014-9-26 下午1:53:45
 */
public class RegistedD7X14Action {
	private List<User> list;		//返回结果集
	private String fileName;		//下载文件的文件名
	private int page = 1;			//分页查询的当前页面数
	private String actionName = "rd7x14";	//请求名
	private String isNull;			//是否过滤用户的电话信息为空的数据
	...
	public String execute(){
		try{
			...
			num = userService.getRegD7L14DaysNum();
			if(num != 0){
				int i = num % 15;
				if(i == 0){
					pageNum = num / 15;
			...
			list = userService.getRegD7L14Days(page, 15);
			return "success";
		}catch(Exception e){
			e.printStackTrace();
			return "error";
	...
	public String download(){
		try{
	        ...
	        String name = "currentMonthRegistrationM7L14Days";
